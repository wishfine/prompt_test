...
def main():
    ...
    input_path = os.path.join(root_dir, "data", "labeled", "physics_difficulty_tiku_data_0714_1000.jsonl")
    output_path = os.path.join(root_dir, "outputs", "model_runs", "physics_teacher_0714_rated.jsonl")
    error_path = os.path.join(root_dir, "outputs", "model_runs", "physics_teacher_0714_errors.jsonl")
